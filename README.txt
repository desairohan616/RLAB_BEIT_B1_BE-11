...
-->The dataset was collected to predict the rank which could be assigned to a faculty/ staff member of the organization. It was collected in 2018-19 nine-month academic salary for Assistant Professors, Associate Professors and Professors in a college in the INDIA. The data were collected as part of the on-going effort of the college's administration to monitor salary differences between male and female faculty members and to also assign a particular rank on the basis of the service years and number of year from passing Phd. 
Total 202 records 
